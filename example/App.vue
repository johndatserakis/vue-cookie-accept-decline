<template>
    <div id="app">
        ...
        <a href="https://github.com/promosis/vue-cookie-accept-decline" target="_blank" class="github-corner" aria-label="View source on Github">
            <svg width="80" height="80" viewBox="0 0 250 250" style="fill:#54AD58; color:#fff; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
